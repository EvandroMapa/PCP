...
final bitolaProduzidaCtrl = BitolaProduzidaController();

class BitolaProduzidaController {
  static final BitolaProduzidaController _instance =
      BitolaProduzidaController._();

  BitolaProduzidaController._();

  factory BitolaProduzidaController() => _instance;

  List<BarSeries<BitolaProduzidaModel, DateTime>> getSource() =>
      getDates(ProdutoProduzido.day)
          .reversed
          .toList()
          .map(
            (e) => BarSeries<BitolaProduzidaModel, DateTime>(
              dataSource: getKilosProduzidos(e),
              name: e.ddMMyyyy(),
              color: e.isSameDay(dayNow())
                  ? AppColors.primaryMain
                  : Colors.grey[400],
              yValueMapper: (BitolaProduzidaModel data, _) => data.qtde as num,
              xValueMapper: (BitolaProduzidaModel data, _) => data.date,
  ...
  List<BitolaProduzidaModel> getKilosProduzidos(DateTime date) {
    List<BitolaProduzidaModel> produzidos = [];
    final ordens =
