...
import 'package:aco_plus/app/modules/graph/bitola_status/bitola_status_controller.dart';
import 'package:aco_plus/app/modules/graph/bitola_status/bitola_status_model.dart';
import 'package:flutter/material.dart';
import 'package:syncfusion_flutter_charts/charts.dart';

class BitolaStatusWidget extends StatefulWidget {
  const BitolaStatusWidget({super.key});

  @override
  State<BitolaStatusWidget> createState() => _GrapOrdemhTotalWidgetState();
}

class _GrapOrdemhTotalWidgetState extends State<BitolaStatusWidget> {
  late StreamSubscription<List<PedidoModel>> pedidoStream;

  late List<ColumnSeries<BitolaStatusGraphModel, String>> data;

  @override
  void initState() {
    data = bitolaStatusCtrl.getSource();
    pedidoStream =
