...
import 'package:aco_plus/app/modules/ordem/ui/ordem/components/timeline/type/ordem_timeline_status_bitola_details.dart';
                ...
                switch (item!.type) {
                  ...
                  OrdemHistoryTypeEnum.statusProdutoAlterada =>
                    OrdemTimelineStatusProdutoDetails(
                      data: item!.data as OrdemHistoryTypeStatusBitolaModel,
                    ),
