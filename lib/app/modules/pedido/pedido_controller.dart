...
class PedidoController {
  ...
  List<PedidoModel> _getPedidosByPrioridadeTipo(
    ...
    final pedidos = BackendClient.pedidos.pedidosPrioridade
  ...
  Future<void> onConfirmarPrioridade(context, PedidoModel pedido) async {
    ...
    await BackendClient.pedidos.updateAll(formPrioridade.pedidos);
  ...
  Future<void> onRemoverPrioridade(
    ...
    await Future.delayed(const Duration(milliseconds: 300));
    await BackendClient.pedidos.update(pedido);
    onReorderPrioridade(BackendClient.pedidos.pedidosPrioridade);
