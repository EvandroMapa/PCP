...
class AutomatizacaoModel {
  ...
  AutomatizacaoModel copyWith({
    ...
    return AutomatizacaoModel(
      ...
      naoMostrarNoCalendario:
          naoMostrarNoCalendario ?? this.naoMostrarNoCalendario,
      removerListaPrioridade:
  ...
  factory AutomatizacaoModel.fromSupabaseMap(Map<String, dynamic> map) {
    ...
    return AutomatizacaoModel(
      criacaoPedido: map['criacao_pedido'] != null
          ? AutomatizacaoItemModel.fromMap(map['criacao_pedido'] is String
      ...
      produzindoCDPedido: map['produzindo_cd_pedido'] != null
          ...
          : empty.produzindoCDPedido,
      prontoCDPedido: map['pronto_cd_pedido'] != null
          ? AutomatizacaoItemModel.fromMap(map['pronto_cd_pedido'] is String
              ? json.decode(map['pronto_cd_pedido'])
              : map['pronto_cd_pedido'])
          : empty.prontoCDPedido,
      aguardandoArmacaoPedido: map['aguardando_armacao_pedido'] != null
          ? AutomatizacaoItemModel.fromMap(
              map['aguardando_armacao_pedido'] is String
                  ? json.decode(map['aguardando_armacao_pedido'])
                  : map['aguardando_armacao_pedido'])
          : empty.aguardandoArmacaoPedido,
      produzindoArmacaoPedido: map['produzindo_armacao_pedido'] != null
          ? AutomatizacaoItemModel.fromMap(
              map['produzindo_armacao_pedido'] is String
                  ? json.decode(map['produzindo_armacao_pedido'])
                  : map['produzindo_armacao_pedido'])
          : empty.produzindoArmacaoPedido,
      prontoArmacaoPedido: map['pronto_armacao_pedido'] != null
          ? AutomatizacaoItemModel.fromMap(
              map['pronto_armacao_pedido'] is String
                  ? json.decode(map['pronto_armacao_pedido'])
                  : map['pronto_armacao_pedido'])
          : empty.prontoArmacaoPedido,
      naoMostrarNoCalendario: map['nao_mostrar_no_calendario'] != null
          ? AutomatizacaoItemModel.fromMap(
              map['nao_mostrar_no_calendario'] is String
                  ? json.decode(map['nao_mostrar_no_calendario'])
                  : map['nao_mostrar_no_calendario'])
          : empty.naoMostrarNoCalendario,
      removerListaPrioridade: map['remover_lista_prioridade'] != null
          ? AutomatizacaoItemModel.fromMap(
              map['remover_lista_prioridade'] is String
                  ? json.decode(map['remover_lista_prioridade'])
                  : map['remover_lista_prioridade'])
          : empty.removerListaPrioridade,
      finalizacaoArmacaoPedido: map['finalizacao_armacao_pedido'] != null
          ? AutomatizacaoItemModel.fromMap(
